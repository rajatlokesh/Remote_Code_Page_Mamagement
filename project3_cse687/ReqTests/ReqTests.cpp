...
{
	std::cout << std::string(100, '-') << "\n";
	std::cout << "\n"<<name()<<"   an interface for the Code Publisher developed in Project #2" << "\n";
	std::cout << std::string(100, '-') << "\n";
	std::cout << " The following files contain the interface for codepublisher with object factory:-\n";
	std::cout<<" Path : "<< Path::getFullFileSpec("../Executive/Executive.h")<<"\n";
	std::cout << " Line Number :# 45 by the name IPublish";
	std::cout << "\n";
	setresult(true);
...
{
	std::cout << std::string(100, '-') << "\n";
	std::cout << "\n" << name() <<"    Publisher as Dynamic Link Library"<< "\n";
	std::cout << std::string(100, '-') << "\n";
	std::cout << "The DLL is in folder:\n";
	std::cout << " Path : " << Path::getFullFileSpec("../debug")<<"\n";
	std::cout << " Name is Shim.dll\n";
	std::cout << " In the folder " << Path::getFullFileSpec("../Shim") << "in the file ITranslator.h ";
	std::cout << "the interface is defined.\n";
	std::cout << "\n";
	return true;
}
